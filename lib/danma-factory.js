...
module.exports.createDanmaFromStrngTypeDanmaContent =
    function (content, videotimestamp, color, user25519seed) {
...
module.exports.checkDanma = function (danma) {
    try {
        ...
        const data = sodium.crypto_sign_open(
            ...
            sodium.from_base64(danma.hashTriples.user25591pubkey),
            "text"
        );
        //console.log(data);
        ...
        if (danma.hashTriples.user25591pubkey
            !==
            datajson.hashTriples.user25591pubkey
        ) {
            console.log("datajson.hashTriples.user25591pubkey");
            return false;
        }
        if (danma.hashTriples.contenthash
            !==
            datajson.hashTriples.contenthash
        ) {
        ...
        if (danma.hashTriples.contenthash
            !==
            datajson.danmaStruct.contenthash
        ) {
            console.log("datajson.danmaStruct.contenthash");
            return false;
        }
...
module.exports.restoreDanmaFromPGPContent =
    function (Base64PGPContent, Base64User25519pubkey) {
        ...
        if (datajson.hashTriples.user25591pubkey
            !==
        ...
        if (typeof datajson.hashTriples.contenthash !== 'string') {
            console.log("datajson.hashTriples.contenthash");
            return false;
        }
        if (datajson.hashTriples.contenthash
            !==
            datajson.danmaStruct.contenthash
        ) {
            console.log("datajson.danmaStruct.contenthash");
        ...
        return {
            ...
            'hashTriples': datajson.hashTriples,
